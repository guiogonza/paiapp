...
class ProfitabilityByVehiclePage extends StatefulWidget {
...
class _ProfitabilityByVehiclePageState extends State<ProfitabilityByVehiclePage> {
  ...
  Future<void> _searchRecords() async {
    ...
    try {
      final records = await _profitabilityService.getRecordsByVehicle(
  ...
  Future<void> _exportToExcel() async {
    ...
    try {
      ...
      await ExcelExportUtils.exportProfitabilityRecords(
        records: _records,
        fileName: fileName,
        title: 'Rentabilidad por Vehículo - ${_selectedVehicle?.placa}',
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Rentabilidad por Vehículo'),
